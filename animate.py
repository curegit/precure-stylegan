...
parser.add_argument("-k", "--current", action="store_true", help="save animations in the current directory")
...
parser.add_argument("-L", "--loop", action="store_true", help="interpolate between the last and first frames")
...
parser.add_argument("-p", "--prefix", type=filename, default="", help="file name prefix for generated images")
parser.add_argument("-g", "--generator", metavar="FILE", help="HDF5 file of a serialized trained model to load")
...
parser.add_argument("-m", "--mlp-depth", metavar="DEPTH", dest="depth", type=natural, default=8, help="MLP depth of the mapping network")
...
parser.add_argument("-a", "--alpha", type=rate, default=1.0, help="the blend alpha")
