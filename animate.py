...
parser.add_argument("-P", "--prepend", metavar="FILE", nargs="+", help="add specified key images to the head")
parser.add_argument("-A", "--append", metavar="FILE", nargs="+", help="add specified key images to the tail")
